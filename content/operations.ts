/**
 * Everything the console reports on that is not a person or a programme:
...
/**
 * Per-module quiz results, for the programme the demo instructor teaches.
 *
 * ONE PROGRAMME ONLY, and that is honest rather than lazy: the console screens
 * that need module-level figures are the instructor's, and inventing 42 sets
 ...
 * also what a real platform says about a programme nobody has finished.
 *
 * The attempt-weighted mean of `averageScore` below is 81%, which is what
 * `MANAGED_PROGRAMMES` declares for Sustainable Energy Transition. The check
 * in `lib/admin.ts` fails the development console if that stops being true.
 *
 * The shape is a funnel, because that is what quizzes on a self-paced course
 * look like: 388 people take the first one and 88 take the last. The two low
 * pass rates are deliberate - they are what an instructor is supposed to
 * notice, and a screen where every module reads 90% teaches nobody anything.
 */
export const QUIZ_STATS: Record<string, QuizStats> = {
  "the-grid-you-already-have": { attempts: 388, passRate: 94, averageScore: 88 },
  "solar-wind-and-what-they-need": {
    attempts: 341,
    passRate: 89,
    averageScore: 85,
  },
  // Below the pass mark on average. The module before it is fine and the one
  // after it is fine, which usually means the question is wrong.
  "reading-a-generation-profile": {
    attempts: 296,
    passRate: 71,
    averageScore: 74,
  },
  ...
  "storage-what-it-solves": { attempts: 214, passRate: 83, averageScore: 82 },
  "efficiency-before-generation": {
    attempts: 186,
    passRate: 90,
    averageScore: 87,
  },
  "running-a-building-energy-audit": {
    attempts: 158,
    passRate: 68,
    averageScore: 71,
  },
  "tariffs-ppas-and-cost-recovery": {
    attempts: 131,
    passRate: 74,
    averageScore: 77,
  },
  "procuring-a-renewable-project": {
    attempts: 104,
    passRate: 81,
    averageScore: 80,
  },
...
export const REVIEWS: Review[] = [
  {
    ...
    rating: 5,
    body: "The proposal module is the first thing I have read that explains why our last two concept notes were returned. I rewrote ours the same week.",
  ...
  },
  {
    ...
    rating: 4,
    body: "Good on planning, thin on procurement. I would have liked one more worked example of a bus priority scheme that actually got funded.",
  ...
  },
  {
    ...
    rating: 5,
    body: "We used the waste characterisation sheet in a council meeting and it settled an argument we have been having for a year.",
  ...
  },
  {
    ...
    programmeId: "green-finance",
    rating: 5,
    body: "Clear, and mercifully free of jargon. The bankability module is worth the whole programme.",
  ...
  },
  {
    ...
    rating: 5,
    body: "I teach part of this material and I still learned how to explain the generation profile properly.",
  ...
  },
  {
    ...
    rating: 4,
    body: "Strong on the plan itself. The costing module moves fast if you have never built a budget line before.",
  ...
  },
  {
    ...
    programmeId: "mobility-landscapes",
    rating: 4,
    body: "The land-use module changed how I read our own zoning plan. More case studies from smaller towns, please.",
  ...
  },
  {
    ...
    programmeId: "sustainable-energy",
    rating: 3,
    body: "Solid material, but the audit module assumes you have meter data nobody in a rural office actually has.",
 ...
 * it is what completing a programme produces, and a register kept by hand
...
export const AUDIT: AuditEntry[] = [
  {
    ...
    target: "Solar, wind and what they need",
    detail: "Sustainable Energy Transition · module 02",
    at: "2026-08-15T09:12",
  },
  {
    id: "log-219",
    ...
    detail: "Green & Climate Finance · 5 stars",
    at: "2026-08-14T16:41",
  },
  {
    id: "log-218",
  ...
  },
  {
    ...
    detail: "Module instructor · no programmes assigned yet",
    at: "2026-08-12T10:22",
  },
  {
    id: "log-216",
  ...
  },
  {
    ...
    target: "Sustainable Mobility & Landscapes",
    detail: "Module 03 rewritten after learner feedback",
    at: "2026-08-13T08:37",
  },
  {
    id: "log-214",
  ...
  },
  {
    ...
    action: "module.published",
    target: "Inside the National Adaptation Plan",
    detail: "Climate Resilience & Adaptation · module 05 revised",
    at: "2026-08-04T11:26",
  },
  {
    id: "log-207",
    ...
    detail: "Module instructor → Administrator",
    at: "2025-11-06T09:03",
  },
  {
    id: "log-206",
    ...
    target: "Sustainable Mobility & Landscapes",
    detail: "7 modules · opened to enrolment",
    at: "2026-02-09T08:15",
  },
  {
    id: "log-205",
  ...
  },
  {
    ...
    action: "programme.updated",
    target: "Green & Climate Finance",
    detail: "Reporting module updated for the 2026 verification rules",
    at: "2026-06-30T16:44",
  },
  {
    id: "log-203",
  ...
  },
  {
    ...
    detail: "Assigned to Sustainable Mobility & Landscapes",
    at: "2026-01-19T09:31",
  },
  {
    id: "log-201",
    actorId: "staff-super",
    action: "programme.published",
    target: "Climate Resilience & Adaptation",
    detail: "First programme on the platform",
    at: "2025-09-08T07:00",
  },
];
...
export const PLATFORM_SETTINGS = {
  ...
  enrolment: {
    ...
    maxProgrammesPerLearner: "No limit",
  ...
  email: {
    ...
    newProgrammeAnnouncements: true,
