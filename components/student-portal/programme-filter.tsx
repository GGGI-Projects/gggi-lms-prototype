 ...
 * only ever decides which of them to mount - the 42-module curriculum, the
 * programme copy and the progress arithmetic all stay on the server and none
...
export function ProgrammeFilter({ items }: { items: FilterableProgramme[] }) {
      ...
      <div className="mt-8">
        {visible.length ? (
          ...
          <EmptyState
            ...
            body="No programme is at that stage yet. Switch the filter above to see the rest of the catalogue."
          />
        )}
      </div>
    </div>
