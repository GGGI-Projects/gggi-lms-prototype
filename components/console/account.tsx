...
const CAPABILITY_LABEL: Record<Capability, string> = {
  ...
  manageModules: "Create a new module, platform-wide",
  manageModuleDetails: "Edit, tag, publish and archive one's own module",
  manageLecturers: "Appoint a lecturer platform-wide, or suspend one's whole account",
  manageModuleLecturers: "Invite, assign or remove a lecturer on one's own module",
  assignModules: "Change which modules a lecturer may write for",
  ...
  manageLaws: "Add, edit, publish and archive laws",
  manageTools: "Add, edit, publish and archive tools",
  manageOptionLists: "Add, rename and retire hazard and category tags",
  manageApplications: "Approve or reject registration applications",
};
