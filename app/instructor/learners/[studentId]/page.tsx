...
/**
 * Only learners on this instructor's modules exist as routes.
 *
 ...
 * this instructor's own modules, lecture by lecture, and how the quizzes went.
 * What is not: email, employer, district, account status, other modules,
                    ...
                    {lectures.map((mod, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <Link
                            href={`/instructor/modules/${mdl.id}/lectures/${mod.id}`}
        ...
        <aside className="min-w-0 space-y-4">
          ...
          <Panel>
            ...
            <p className={`mt-3 ${BODY.base}`}>
              ...
              module of somebody else&rsquo;s they are enrolled on, and every
