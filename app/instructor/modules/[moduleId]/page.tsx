...
/**
 * Only the modules this instructor is assigned to exist as routes.
 *
...
export default async function InstructorModulePage({ params }: Params) {
  ...
  return (
    <PageBody>
      <PageHeader
        back={{ href: "/instructor/modules", label: "My modules" }}
        eyebrow="Module"
        title={mdl.title}
      ...
      {mdl.status === "draft" ? (
        <div className={CONSOLE.stack}>
          <Callout tone="info" title="Not published">
            ...
            ask an administrator to publish the module - instructors write
