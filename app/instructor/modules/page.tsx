...
/**
 * Every module this instructor is assigned to, as cards.
 *
      ...
      {load.modules.length ? (
        ...
        <div className={CONSOLE.stack}>
          <EmptyState
            ...
            body="An administrator assigns modules to instructors. Once one is assigned, it appears here as a card and you can open it to start writing."
          />
        </div>
      )}
    </PageBody>
