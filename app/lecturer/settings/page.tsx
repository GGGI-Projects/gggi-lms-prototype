 ...
 *
 * THE PLATFORM'S RULES ARE SHOWN BUT NOT EDITABLE. A lecturer asked "why is
  ...
  return (
    <PageBody>
      <PageHeader
        ...
        actions={
          <Link href="/lecturer/profile" className="btn-ripple btn-solid btn-sm">
      ...
      <div className={`${CONSOLE.stack} grid gap-4 lg:grid-cols-3`}>
        <div className="min-w-0 space-y-4 lg:col-span-2">
          ...
          >
            ...
            <Toggle
              ...
              description="A code from an authenticator app as well as a password. Optional for lecturers, required for the super administrator."
              defaultChecked
            />
          </SettingsGroup>
          ...
          >
            ...
            <Toggle
              ...
              description="When a file you uploaded is picked up by another lecturer's lecture."
        ...
        <aside className="min-w-0 space-y-4">
          ...
          <Panel>
            ...
            <p className={`mt-3 ${BODY.base}`}>
              A lecturer account is closed by an administrator, not from
